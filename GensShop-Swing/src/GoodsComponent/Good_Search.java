...
public class Good_Search extends JPanel implements ActionListener {
		...
		public TxT_id() {
			...
			try {
				...
				for (Iterator it = good.iterator(); it.hasNext();) {
					...
					addItem(String.valueOf(list.getG_id()));
				}
	...
	public Good_Search(Runnable Mainframe) {
		Main = Mainframe;
		...
		JLabel header = new JLabel("SEARCH GOOD");
		...
		ImageIcon imgid = new ImageIcon("./imge/products mini.png");
		lbid.setIcon(imgid);
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (command.equals("SEARCH")) {
			try {
				...
				Vector<Good> good = Good_DAO.searchGood(id);
