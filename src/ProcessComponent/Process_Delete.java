...
public class Process_Delete extends JPanel implements ActionListener {
			...
			addItemListener(new ItemListener() {
				...
				public void itemStateChanged(ItemEvent e) {
					...
					if (e.getStateChange() == ItemEvent.SELECTED) {
						...
						if (getSelectedItem().toString().equals("Chose Product Id")) {
							...
							try {
								...
								List<Products> product = ProductDAO.ProductsDetail(i);
	...
	public Process_Delete(Runnable Mainframe) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (command.equals("DELETE")) {
			...
			try {
				...
				Good_DAO upstatus = new Good_DAO();
				if (upstatus.Updatestatus(id)) {
					JOptionPane.showMessageDialog(null, "DELETE SUCESSFULL", "DELETE Product",
